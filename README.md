...
Finally we used the ratio method to determine significance in the Mendelian Randomization analysis as implemented in the R package MendelianRandomization where MRbeta=BETA CpG~SNP / BETA CRP~SNP and performed a triangulation analysis. This technically simple and was done with this [script](Risk_Score/metal_meta.sh) the concept and motivation to do that is explained below.    
