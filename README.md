...
>>* we used this [script]() to bin the 450k probes according their standard errors observed in the participating cohorts, those were stored in this [file]()    
>>* we counted the number of probes in each bin for the significant loci also given in this [script]()  
