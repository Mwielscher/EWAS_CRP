...
rvtest --inVcf ${indir}nfbc1966_for_meth.vcf.gz --pheno ${indir}MR_pheno_nfbc1966.pheno --pheno-name lnCRP --covar ${indir}MR_pheno_nfbc1966.covar\
--covar-name ${i},sex,age,CD8T,CD4T,NK,Bcell,Mono,Neu,Eos --rangeList ${k} --out ${outdir}DIRECT_EFF_${i} --kinship ${indir}nfbc1966_kinship.kinship\
--meta dominant --freqLower 0.025
