...
rvtest --inVcf ${indir}nfbc1966_for_meth.vcf.gz --pheno ${indir}MR_pheno_nfbc1966.pheno --pheno-name ${i} --covar ${indir}MR_pheno_nfbc1966.covar\
 --covar-name sex,age,CD8T,CD4T,NK,Bcell,Mono,Neu,Eos --rangeList ${k} --out ${interdir}${i} --kinship ${indir}nfbc1966_kinship.kinship --meta dominant\ 
 --freqLower 0.025
