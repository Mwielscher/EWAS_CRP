...
for (k in CpGs){
  ...
  i=i+1
  ###  ---------------------   models
  cmod=paste("lnCRP","~ smoke + age + sex + CD4T + NK + Bcell + Mono + Neu + Eos",sep=" ")    # C path
  amod=paste(k," ~ smoke + age + sex + CD4T + NK + Bcell + Mono + Neu + Eos",sep="")          # A path
  bmod=paste("lnCRP ~",k, " +smoke + age + sex + CD4T + NK + Bcell + Mono + Neu + Eos",sep=" ")     # B path
  c2mod=paste("lnCRP ~ smoke +", k," + age + sex + CD4T + NK + Bcell + Mono + Neu + Eos",sep=" ")     # C' path
...
write.csv(resC,file="model_6_pathC_nfbc1966.csv")
write.csv(resC2,file="model_6_pathC2_nfbc1966.csv")
write.csv(resA,file="model_6_pathA_nfbc1966.csv")
write.csv(resB,file="model_6_pathB_nfbc1966.csv")